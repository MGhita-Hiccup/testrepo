  ...
  return (
    ...
    <div  className="col-md-3">
      <Link to={'/MovieDetails/' + movie.id + '/' + movie.media_type}>
        <div className='item'>
            <div className="movie gy-3 position-relative">
                { movie.profile_path? <img className='w-100 h-100' src= {'https://image.tmdb.org/t/p/w500' + movie.profile_path} />: ''}
                { movie.poster_path? <img className='w-100 h-100' src= {'https://image.tmdb.org/t/p/w500' + movie.poster_path} />:''}
